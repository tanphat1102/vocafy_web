...
export function CircleImageFrame({
  ...
  return (
    <div
      className={cn(
        "relative flex justify-center items-end gap-4 py-8",
        className,
      )}
    >
      {/* Circle frames for images */}
      <div className="w-32 h-32 md:w-40 md:h-40 rounded-full overflow-hidden border-4 border-white dark:border-gray-700 shadow-xl bg-linear-to-br from-indigo-100 to-blue-100 dark:from-gray-700 dark:to-gray-600 -rotate-6 hover:rotate-0 transition-transform duration-500">
        {children || (
      ...
      <div className="w-36 h-36 md:w-48 md:h-48 rounded-full overflow-hidden border-4 border-white dark:border-gray-700 shadow-xl bg-linear-to-br from-purple-100 to-pink-100 dark:from-gray-700 dark:to-gray-600 hover:scale-105 transition-transform duration-500">
        {children || (
          <div className="w-full h-full flex items-center justify-center">
      ...
      <div className="w-28 h-28 md:w-36 md:h-36 rounded-full overflow-hidden border-4 border-white dark:border-gray-700 shadow-xl bg-linear-to-br from-emerald-100 to-teal-100 dark:from-gray-700 dark:to-gray-600 rotate-6 hover:rotate-0 transition-transform duration-500">
        {children || (
          <div className="w-full h-full flex items-center justify-center">
      ...
      <div className="w-32 h-32 md:w-44 md:h-44 rounded-full overflow-hidden border-4 border-white dark:border-gray-700 shadow-xl bg-linear-to-br from-amber-100 to-orange-100 dark:from-gray-700 dark:to-gray-600 -rotate-3 hover:rotate-0 transition-transform duration-500">
        {children || (
          <div className="w-full h-full flex items-center justify-center">
            <span className="text-4xl">{placeholderText || "🚀"}</span>
          </div>
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <div className={cn("relative", isReversed && "md:order-1")}>
            {imageContent || (
              <div className="aspect-video bg-linear-to-br from-indigo-400 via-purple-400 to-pink-400 rounded-2xl shadow-xl flex items-center justify-center">
