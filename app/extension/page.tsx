...
const features = [
  {
    ...
    description: "Double-click any word on any website to instantly see its translation and add it to your vocabulary list.",
    color: "from-blue-400 to-cyan-400",
  },
  {
    icon: Volume2,
    title: "Audio Pronunciation",
    description: "Listen to native speaker pronunciation for every word you translate.",
    color: "from-purple-400 to-pink-400",
  },
  {
    icon: BookOpen,
    title: "Context Learning",
    description: "Save words with the context sentence for better understanding and retention.",
    color: "from-emerald-400 to-teal-400",
  },
  {
    icon: History,
    title: "Review History",
    description: "Access your translation history and review saved words anytime.",
    color: "from-orange-400 to-red-400",
  },
  {
    icon: Zap,
    title: "Spaced Repetition",
    description: "Get smart reminders to review words using our spaced repetition algorithm.",
    color: "from-indigo-400 to-purple-400",
  },
  {
    icon: Globe,
    title: "Multi-Language",
    description: "Support for Japanese, English, and more languages coming soon.",
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <FadeInOnScroll className="space-y-6">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight dark:text-white">
              Learn Vocabulary{" "}
              <span className="text-indigo-600 dark:text-indigo-400">While Browsing</span>
            </h1>
            
            <p className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed">
              Our Chrome extension turns every website into a learning opportunity. 
              Double-click any word to instantly translate and save it to your vocabulary list.
            </p>

            <div className="flex flex-wrap gap-4">
              <Button size="lg" className="bg-indigo-600 hover:bg-indigo-700 h-14 px-8 text-lg rounded-full group">
                <Chrome className="w-5 h-5 mr-2" />
                Add to Chrome
                <ArrowRight className="ml-2 h-5 w-5 group-hover:translate-x-1 transition-transform" />
              </Button>
              <Button size="lg" variant="outline" className="h-14 px-8 text-lg rounded-full dark:border-gray-600 dark:text-gray-300">
                Watch Demo
              </Button>
            </div>
            ...
            <div className="flex items-center gap-6 pt-4">
              ...
              <span className="text-gray-600 dark:text-gray-300">
                <CountingNumber value={4.9} decimals={1} /> rating • <CountingNumber value={5000} suffix="+" /> users
              </span>
            </div>
          </FadeInOnScroll>
              ...
              <div className="aspect-square max-w-md mx-auto bg-gradient-to-br from-indigo-400 via-purple-400 to-pink-400 rounded-3xl shadow-2xl overflow-hidden relative group">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-white text-center group-hover:scale-110 transition-transform duration-500">
                    ...
                    <div className="text-indigo-100 mt-2">Learn anywhere on the web</div>
                  </div>
                </div>
        ...
        <div className="container mx-auto px-4">
          <FadeInOnScroll className="text-center mb-12">
            ...
            <p className="text-gray-600 dark:text-gray-300 mt-4 max-w-2xl mx-auto">
              Everything you need to learn vocabulary efficiently while browsing the web.
            </p>
          </FadeInOnScroll>
